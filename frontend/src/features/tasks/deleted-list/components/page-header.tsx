...
interface DeletedListPageHeaderProps {
...
export default function DeletedListPageHeader({ actor }: DeletedListPageHeaderProps) {
  return (
    <header className="flex flex-col justify-between gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm lg:flex-row lg:items-center">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-950">Deleted Tasks</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
          View tasks that were soft deleted. Deleted tasks are not shown in the active task list but
          remain available for audit visibility.
        </p>
      </div>
