...
interface DeletedTaskSearchBarProps {
  value: string
  onChange: (value: string) => void
  onClear: () => void
}

export default function DeletedTaskSearchBar({
  value,
  onChange,
  onClear,
}: DeletedTaskSearchBarProps) {
  return (
    <div className="mb-4 flex flex-col gap-2 sm:flex-row">
      <div className="relative flex-1">
        ...
        <Input
          type="search"
          placeholder="Search by title, description, status, creator, or deleted actor"
